...
public class UpdateableManager {
    ...
    public static Boolean checkForUpdate(Updateable updateable){
    	try {
    		URL last = null;
			try {
    ...
    public static void checkAndRunUpdate(final Updateable updateable, final Boolean reload){
    	try {
			...
			final URL update = FileGetter.getLatestPluginFileURL(updateable);
    ...
    public static void checkAll(){
    	Thread updater = new Thread(){ //ONE updater thread
    		public void run(){
    			checked = 0;
    			runningUpdates = true;
